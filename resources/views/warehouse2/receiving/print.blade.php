...
<head>
    ...
    <title>BTB - {{ $receiving->receipt_number }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="info">
        <table>
            <tr>
                <td class="label">Nomor BTB</td>
                <td class="separator">:</td>
                <td><strong>{{ $receiving->receipt_number }}</strong></td>
            </tr>
            <tr>
                <td class="label">Tanggal</td>
                <td class="separator">:</td>
                <td>{{ \Carbon\Carbon::parse($receiving->receipt_date)->format('d/m/Y') }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="separator">:</td>
                <td>{{ $receiving->created_by_name ?? 'Administrator' }}</td>
            </tr>
            @if($receiving->notes)
            <tr>
    ...
    <script>
        // Fungsi untuk print otomatis (opsional)
