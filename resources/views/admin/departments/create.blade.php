...
@section('title', 'Tambah Departemen - Engineering Apps')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col gap-1">
        <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tambah Departemen</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">Buat master departemen untuk user dan report budget consume</p>
    </div>
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div class="border-b border-gray-200 px-6 py-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Form Departemen Baru</h2>
                    <p class="mt-1 text-sm text-gray-500">Kode dipakai sebagai key report dan relasi user</p>
                </div>
